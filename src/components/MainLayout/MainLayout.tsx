...
import { IconHome, IconFolders, IconSettings, IconLogout, IconChevronLeft, IconChevronRight, IconSun, IconMoon, IconChecklist, IconWallet } from '@tabler/icons-react';
