...
export function CriteriaListPage() {
  ...
  return (
    <Stack gap="lg">
      ...
      {error && (
        <Alert color="red" icon={<IconAlertCircle size={16} />} onClose={() => setError('')} withCloseButton>
          {error}
        </Alert>
      )}
      ...
      <Group grow>
        <TextInput
          ...
          rightSection={<ActionIcon variant="transparent" onClick={() => setSearch("")}><IconX size={16} color="gray" /></ActionIcon>}
        />
        <MultiSelect
          data={tags}
          value={selectedTags}
