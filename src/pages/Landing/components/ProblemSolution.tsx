...
const solutions = [
	'Автоматическая генерация документации проекта для быстрого ознакопления.',
	'Проверка по критериям и формирование рекомендуемой оценки.',
	'Генерация мотивирующей обратной связи для студента.',
	'Преподаватель только проверяет комментарии по проверке и корректируем финальный вердикт.',
];
