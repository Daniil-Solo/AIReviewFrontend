...
import { IconQuote, IconUsers, IconClock, IconChecklist, IconSchool, IconRobot } from '@tabler/icons-react'
      ...
      <Container size="lg">
          ...
          <SimpleGrid cols={{ base: 1, md: 2 }} spacing="xl">
            <Box>
              ...
              <Text fz="lg" fw={500} lh={1.6} mb="md">
                Платформа прошла апробацию в рамках реального учебного процесса. Студенты загружали свои проекты через GitHub, получали детальную обратную связь за считанные минуты, а не дни.
              </Text>
              <Text fz="lg" fw={500} lh={1.6}>
                Преподаватели смогли сократить время на проверку работ на 90%, сосредоточившись на творческих аспектах обучения.
              </Text>
            </Box>
            
            <Box className={styles.featuresList}>
              <Text fw={700} size="md" mb="md">Что включает проверка:</Text>
        ...
        <SimpleGrid cols={{ base: 1, sm: 3 }} spacing="lg" mt={48}>
          <Box className={styles.statCard}>
            ...
            <Text fw={800} fz={40} c="blue.5">50+</Text>
            <Text size="md" c="dimmed">студентов прошли проверку</Text>
          </Box>
          <Box className={styles.statCard}>
            <ThemeIcon size={48} radius="xl" variant="light" color="teal" mb="sm">
              <IconClock size={24} />
            </ThemeIcon>
            <Text fw={800} fz={40} c="teal.5">90%</Text>
            <Text size="md" c="dimmed">экономия времени преподавателей</Text>
          </Box>
          <Box className={styles.statCard}>
            <ThemeIcon size={48} radius="xl" variant="light" color="grape" mb="sm">
              <IconSchool size={24} />
            </ThemeIcon>
            <Text fw={800} fz={40} c="grape.5">5-15</Text>
            <Text size="md" c="dimmed">минут на полный анализ проекта</Text>
          </Box>
        </SimpleGrid>
      </Container>
    </Box>
