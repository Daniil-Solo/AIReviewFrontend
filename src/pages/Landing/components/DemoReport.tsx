				...
				<Card className={styles.reportCard} padding="xl" radius="lg">
					<Tabs defaultValue="criteria" className={styles.tabs}>
						...
						<Tabs.Panel value="criteria">
							<Stack gap="lg">
								<Text fw={600} size="lg">
									Результаты критериальной проверки
								</Text>
						...
						<Tabs.Panel value="analysis">
							<Stack gap="md">
								...
								<Text c="dimmed">
									Результаты анализа кода с помощью Bandit, Pylint и других инструментов. Список
									предупреждений, ошибок и рекомендаций по улучшению кода.
								</Text>
								<Box className={styles.codeBlock}>
									<Text size="sm" style={{ fontFamily: 'monospace' }}>
										banditi: Found 1 medium severity vulnerability
										<br />
						...
						<Tabs.Panel value="exam">
							<Stack gap="md">
								<Text fw={600} size="lg">
									Вопросы экзамена и ответы студента
								</Text>
								<Text c="dimmed">
									AI генерирует вопросы на основе кода студента, проверяя понимание архитектуры,
									слабых мест и_best practices. Студент отвечает устно или письменно.
								</Text>
								<Box className={styles.examExample}>
									...
									<Text>
										Объясните, почему вы выбрали именно эту архитектуру для микросервисов?
									</Text>
