...
const features = [
	{
		...
		description:
			'Анализ кода в целом, критериальная проверка, проверка с помощью статических анализаторов, проведение экзамена',
		color: 'blue',
	},
	{
		icon: IconCreditCard,
		...
		description:
			'Прозрачная система оплаты, вы платите соразмерно проектам студентов, а также бонус при регистрации',
		color: 'grape',
	},
	{
		icon: IconChartLine,
	...
	},
	{
		...
		description:
			'Подключайте репозитории студентов напрямую через GitHub для автоматической проверки',
		color: 'orange',
	},
];
